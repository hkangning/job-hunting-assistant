...
//       后端 application_service.LEGAL_TRANSITIONS（SRS FR-004 v1.8 状态机）
...
// 合法流转（SRS FR-004 v1.8）：链上顺序 已投递→待笔试→面试中→已获 offer；
// 可前进到链上任意更靠后的状态（**跳级合法**——有些公司不设笔试，已投递可直接进面试中），亦可终止；
// 除「已结束」外任意状态均可流转至「已结束」（含已获 offer——拒 offer / offer 撤回 / 谈崩）；
// 不可回退、不可原地
export const LEGAL_TRANSITIONS = {
  APPLIED: ['WRITTEN', 'INTERVIEW', 'OFFER', 'CLOSED'],
  WRITTEN: ['INTERVIEW', 'OFFER', 'CLOSED'],
